...
@section('content')
    <form class="form-signin" action="/user/login" method="post">
        ...
        <a href="https://open.weixin.qq.com/connect/qrconnect?appid=wxe24f70961302b5a5&amp;redirect_uri=http%3a%2f%2fmall.77sc.com.cn%2fweixin.php%3fr1http%3A%2F%2Fyxm.52self.cn%2Fweixin%2Fgetcode&amp;response_type=code&amp;scope=snsapi_login&amp;state=STATE#wechat_redirect" class="btn btn-lg btn-primary btn-block" type="submit">微信登录</a><br>
